        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Avatar className="h-8 w-8 hover:cursor-pointer">
              <AvatarImage
                src={(() => {
                  // Try to get profile image from database first
                  // This would need to be fetched from profiles table in a real implementation
                  // For now, using the dicebear fallback
